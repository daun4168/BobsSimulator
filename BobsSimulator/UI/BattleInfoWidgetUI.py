...
class Ui_BattleInfoWidget(object):
    def setupUi(self, BattleInfoWidget):
        ...
        self.optimizeButton = QPushButton(BattleInfoWidget)
        self.optimizeButton.setObjectName(u"optimizeButton")
        self.optimizeButton.setGeometry(QRect(390, 490, 231, 61))
        ...
        font2.setBold(True)
        font2.setWeight(75)
        self.optimizeButton.setFont(font2)
        ...
        self.simulateButton.setGeometry(QRect(180, 490, 201, 61))
    ...
    def retranslateUi(self, BattleInfoWidget):
        ...
        self.optimizeButton.setText(QCoreApplication.translate("BattleInfoWidget", u"OPTIMIZE", None))
